    ...
    <Layout className="min-h-screen">
      ...
      >
        <main className="h-full w-full max-w-prose relative pb-20">
          ...
          <br />
          <Paragraph>
            The Study Planner team is passionate about consumer protection.
            Please don&apos;t hesitate to reach out to us regarding your rights
            as a user. We also encourage you to take a look at the{" "}
            <Link
          ...
          <Paragraph>
            Used for automated error reports. The servers our Sentry project
            runs on are located in the European Union. Sentry receives logs
            about you including date and time of access, your ip address, and
            information about your hardware, operating system, and browser. This
            helps us provide a better service by discovering issues.{" "}
          ...
          <Paragraph>
            ...
            servers. Using a token created by the LP servers, we communicate
            with them both from your browser and from our own servers. This
            token gives us unrestricted access to your LP account and
            doesn&apos;t get stored on our servers.
          </Paragraph>
          <Paragraph>
          ...
          <Paragraph>
            Requests we make from your browser to the LP servers get proxied
            over our own servers. This means that we have temporary access to
            all data the Study Planner requests from the LP as the data passes
            through our servers. Most of this data doesn&apos;t get permanently
            stored.
          </Paragraph>
          <Paragraph>
          ...
          <Paragraph>
            ...
            <ul>
              <li>
                Your user id for the Learning Platform. This can be linked back
                to your LP profile.
              </li>
        ...
        being prefixed with `cache:`. */}
          ...
          <Paragraph>
            <ul>
              ...
              <li>
                <b>Right to Rectification (Article 16)</b> If we process
                incorrect data about you, you have the right to have it
                rectified without undue delay.
              </li>
              <li>
                <b>Right to Erasure (Article 17)</b> You can request at any time
                that we erase all personal data we hold about you, provided
                there are no legal obligations preventing such deletion.
              </li>
              <li>
              ...
              <li>
                <b>Notification Obligation (Article 19)</b> If we rectify or
                erase your data, or restrict its processing, you have the right
